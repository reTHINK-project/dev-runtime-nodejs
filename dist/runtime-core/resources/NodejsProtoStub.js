...
!function (t) {
  ...
  var t;return function e(t, n, r) {
    function o(s, a) {
      ...
      !function (t) {
        ...
        n.encode = function (e) {
          ...
          var n,
              ...
              a = .75 * e.length,
              c = e.length,
              u = 0;"=" === e[e.length - 1] && (a--, "=" === e[e.length - 2] && a--);var p = new ArrayBuffer(a),
              f = new Uint8Array(p);for (n = 0; c > n; n += 4) {
            r = t.indexOf(e[n]), o = t.indexOf(e[n + 1]), i = t.indexOf(e[n + 2]), s = t.indexOf(e[n + 3]), f[u++] = r << 2 | o >> 4, f[u++] = (15 & o) << 4 | i >> 2, f[u++] = (3 & i) << 6 | 63 & s;
          }return p;
        };
      ...
      function r() {
        ...
        function e() {}function o() {
          var t = o,
              e = +new Date(),
              i = e - (u || e);t.diff = i, t.prev = u, t.curr = e, u = e, null == t.useColors && (t.useColors = n.useColors()), null == t.color && t.useColors && (t.color = r());var s = Array.prototype.slice.call(arguments);s[0] = n.coerce(s[0]), "string" != typeof s[0] && (s = ["%o"].concat(s));var a = 0;s[0] = s[0].replace(/%([a-z%])/g, function (e, r) {
      ...
      }n = e.exports = o, n.coerce = c, n.disable = s, n.enable = i, n.enabled = a, n.humanize = t("ms"), n.names = [], n.skips = [], n.formatters = {};var u,
          p = 0;
      ...
      (function (n) {
        function r(t, e) {
          ...
          var e = {};for (var n in t) {
            ...
            p = t("parseuri"),
            f = t("parsejson"),
            h = t("parseqs");e.exports = r, r.priorWebsocketSuccess = !1, s(r.prototype), r.protocol = u.protocol, r.Socket = r, r.Transport = t("./transport"), r.transports = t("./transports"), r.parser = t("engine.io-parser"), r.prototype.createTransport = function (t) {
          a('creating transport "%s"', t);var e = o(this.query);e.EIO = u.protocol, e.transport = t, this.id && (e.sid = this.id);var n = new i[t]({ agent: this.agent, hostname: this.hostname, port: this.port, secure: this.secure, path: this.path, query: e, forceJSONP: this.forceJSONP, jsonp: this.jsonp, forceBase64: this.forceBase64, enablesXDR: this.enablesXDR, timestampRequests: this.timestampRequests, timestampParam: this.timestampParam, policyPort: this.policyPort, socket: this, pfx: this.pfx, key: this.key, passphrase: this.passphrase, cert: this.cert, ca: this.ca, ciphers: this.ciphers, rejectUnauthorized: this.rejectUnauthorized, perMessageDeflate: this.perMessageDeflate, extraHeaders: this.extraHeaders });return n;
          ...
          function e() {
            ...
            }f || (a('probe transport "%s" opened', t), p.send([{ type: "ping", data: "probe" }]), p.once("packet", function (e) {
              if (!f) if ("pong" == e.type && "probe" == e.data) {
                if (a('probe transport "%s" pong', t), h.upgrading = !0, h.emit("upgrading", p), !p) return;r.priorWebsocketSuccess = "websocket" == p.name, a('pausing current transport "%s"', h.transport.name), h.transport.pause(function () {
                ...
                a('probe transport "%s" failed', t);var n = new Error("probe error");n.transport = p.name, h.emit("upgradeError", n);
              }
            }));
          }function n() {
            f || (f = !0, u(), p.close(), p = null);
          }function o(e) {
            var r = new Error("probe error: " + e);r.transport = p.name, n(), a('probe transport "%s" failed because of error: %s', t, e), h.emit("upgradeError", r);
          }function i() {
            o("transport closed");
          }function s() {
            o("socket closed");
            ...
            p.removeListener("open", e), p.removeListener("error", o), p.removeListener("close", i), h.removeListener("close", s), h.removeListener("upgrading", c);
              ...
              f = !1,
              h = this;r.priorWebsocketSuccess = !1, p.once("open", e), p.once("error", o), p.once("close", i), this.once("close", s), this.once("upgrading", c), p.open();
        ...
        function r(t) {
          var n,
            ...
            var u = "https:" == location.protocol,
                p = location.port;p || (p = u ? 443 : 80), r = t.hostname != location.hostname || p != t.port, a = t.secure != u;
      ...
      (function (n) {
        function r() {}function o(t) {
          ...
          for (var t in i.requests) {
            ...
            p = t("component-inherit"),
            f = t("debug")("engine.io-client:polling-xhr");e.exports = o, e.exports.Request = i, p(o, c), o.prototype.supportsBinary = !0, o.prototype.request = function (t) {
      ...
      function r(t) {
        var e = t && t.forceBase64;(!p || e) && (this.supportsBinary = !1), o.call(this, t);
          ...
          c = t("yeast"),
          u = t("debug")("engine.io-client:polling");e.exports = r;var p = function () {
    ...
    }, { "../transport": 15, "component-inherit": 9, debug: 10, "engine.io-parser": 22, parseqs: 31, "xmlhttprequest-ssl": 21, yeast: 45 }], 20: [function (t, e, n) {
      (function (n) {
        function r(t) {
          var e = t && t.forceBase64;e && (this.supportsBinary = !1), this.perMessageDeflate = t.perMessageDeflate, o.call(this, t);
            ...
            f = p;if (!f && "undefined" == typeof window) try {
          f = t("ws");
        } catch (h) {}e.exports = r, a(r, o), r.prototype.name = "websocket", r.prototype.supportsBinary = !0, r.prototype.doOpen = function () {
          if (this.check()) {
            var t = this.uri(),
                e = void 0,
                n = { agent: this.agent, perMessageDeflate: this.perMessageDeflate };n.pfx = this.pfx, n.key = this.key, n.passphrase = this.passphrase, n.cert = this.cert, n.ca = this.ca, n.ciphers = this.ciphers, n.rejectUnauthorized = this.rejectUnauthorized, this.extraHeaders && (n.headers = this.extraHeaders), this.ws = p ? new f(t) : new f(t, e, n), void 0 === this.ws.binaryType && (this.supportsBinary = !1), this.ws.supports && this.ws.supports.binary ? (this.supportsBinary = !0, this.ws.binaryType = "buffer") : this.ws.binaryType = "arraybuffer", this.addEventListeners();
          }
    ...
    }, { "../transport": 15, "component-inherit": 9, debug: 10, "engine.io-parser": 22, parseqs: 31, ws: 6, yeast: 45 }], 21: [function (t, e, n) {
      ...
      (function (e) {
        function r(t, e) {
          ...
          var o = "b" + n.packets[t.type];if (w && t.data instanceof e.Blob) {
            ...
            for (var c = new Uint8Array(t.data), u = new Array(c.length), p = 0; p < c.length; p++) {
              u[p] = c[p];
          ...
          if ("string" == typeof t || void 0 === t) {
            if ("b" == t.charAt(0)) return n.decodeBase64Packet(t.substr(1), e);if (r) try {
              ...
              i = s[0],
              a = p(t, 1);return w && "blob" === e && (a = new w([a])), { type: b[i], data: a };
          ...
          }"function" == typeof e && (r = e, e = null);var s = u(t);return e && s ? w && !g ? n.encodePayloadAsBlob(t, r) : n.encodePayloadAsArrayBuffer(t, r) : t.length ? void a(t, i, function (t, e) {
            return r(e.join(""));
          }) : r("0:");
        }, n.decodePayload = function (t, e, r) {
          if ("string" != typeof t) return n.decodePayloadAsBinary(t, e, r);"function" == typeof e && (r = e, e = null);var o;if ("" == t) return r(v, 0, 1);for (var i, s, a = "", c = 0, u = t.length; u > c; c++) {
            var p = t.charAt(c);if (":" != p) a += p;else {
              if ("" == a || a != (i = Number(a))) return r(v, 0, 1);if (s = t.substr(c + 1, i), a != s.length) return r(v, 0, 1);if (s.length) {
                if (o = n.decodePacket(s, e, !0), v.type == o.type && v.data == o.data) return r(v, 0, 1);var f = r(o, c + i, u);if (!1 === f) return;
              }c += i, a = "";
            }
          ...
          "function" == typeof e && (r = e, e = null);for (var o = t, i = [], s = !1; o.byteLength > 0;) {
            ...
            }if (s) return r(v, 0, 1);o = p(o, 2 + u.length), u = parseInt(u);var h = p(o, 0, u);if (c) try {
    ...
    }, { "./keys": 23, after: 1, "arraybuffer.slice": 2, "base64-arraybuffer": 4, blob: 5, "has-binary": 24, utf8: 44 }], 23: [function (t, e, n) {
      ...
      function r(t) {
        ...
        return t >= p ? Math.round(t / p) + "d" : t >= u ? Math.round(t / u) + "h" : t >= c ? Math.round(t / c) + "m" : t >= a ? Math.round(t / a) + "s" : t + "ms";
      }function i(t) {
        return s(t, p, "day") || s(t, u, "hour") || s(t, c, "minute") || s(t, a, "second") || t + " ms";
      }function s(t, e, n) {
        return e > t ? void 0 : 1.5 * e > t ? Math.floor(t / e) + " " + n : Math.ceil(t / e) + " " + n + "s";
          ...
          u = 60 * c,
          p = 24 * u,
          f = 365.25 * p;e.exports = function (t, e) {
      ...
      function r(t, e) {
        "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) && (e = t, t = void 0), e = e || {};var n,
            ...
            p = r.path,
            f = c[u] && p in c[u].nsps,
            h = e.forceNew || e["force new connection"] || !1 === e.multiplex || f;return h ? (a("ignoring socket cache for %s", i), n = s(i, e)) : (c[u] || (a("new io instance for %s", i), c[u] = s(i, e)), n = c[u]), n.socket(r.path);
      }var o = t("./url"),
    ...
    }, { "./manager": 34, "./socket": 36, "./url": 37, debug: 10, "socket.io-parser": 40 }], 34: [function (t, e, n) {
      function r(t, e) {
        ...
        if (p("readyState %s", this.readyState), ~this.readyState.indexOf("open")) return this;p("opening %s", this.uri), this.engine = o(this.uri, this.opts);var e = this.engine,
          ...
          var s = this._timeout;p("connect attempt will timeout after %d", s);var a = setTimeout(function () {
        ...
        p("writing packet %j", t);var e = this;e.encoding ? e.packetBuffer.push(t) : (e.encoding = !0, this.encoder.encode(t, function (n) {
        ...
        p("cleanup");for (var t; t = this.subs.shift();) {
          t.destroy();
        ...
        if (this.reconnecting || this.skipReconnect) return this;var t = this;if (this.backoff.attempts >= this._reconnectionAttempts) p("reconnect failed"), this.backoff.reset(), this.emitAll("reconnect_failed"), this.reconnecting = !1;else {
          var e = this.backoff.duration();p("will wait %dms before reconnect attempt", e), this.reconnecting = !0;var n = setTimeout(function () {
    ...
    }, { "./on": 35, "./socket": 36, backo2: 3, "component-bind": 7, "component-emitter": 38, debug: 10, "engine.io-client": 12, indexof: 27, "socket.io-parser": 40 }], 35: [function (t, e, n) {
      function r(t, e, n) {
      ...
      function r(t, e) {
        this.io = t, this.nsp = e, this.json = this, this.ids = 0, this.acks = {}, this.receiveBuffer = [], this.sendBuffer = [], this.connected = !1, this.disconnected = !0, this.io.autoConnect && this.open();
          ...
          p = t("has-binary");e.exports = n = r;var f = { connect: 1, connect_error: 1, connect_timeout: 1, connecting: 1, disconnect: 1, error: 1, reconnect: 1, reconnect_attempt: 1, reconnect_failed: 1, reconnect_error: 1, reconnecting: 1, ping: 1, pong: 1 },
        ...
        var e = t.data || [];u("emitting event %j", e), null != t.id && (u("attaching ack callback to event"), e.push(this.ack(t.id))), this.connected ? h.apply(this, e) : this.receiveBuffer.push(e);
      }, r.prototype.ack = function (t) {
        var e = this,
            n = !1;return function () {
          if (!n) {
            n = !0;var r = s(arguments);u("sending ack %j", r);var i = p(r) ? o.BINARY_ACK : o.ACK;e.packet({ type: i, id: t, data: r });
          }
        };
    ...
    }, { "./on": 35, "component-bind": 7, "component-emitter": 38, debug: 10, "has-binary": 25, "socket.io-parser": 40, "to-array": 43 }], 37: [function (t, e, n) {
      (function (n) {
        function r(t, e) {
          var r = t,
        ...
        var r = t("isarray"),
          ...
          function i(t, c, u) {
            if (!t) return t;if (e.Blob && t instanceof Blob || e.File && t instanceof File) {
              s++;var p = new FileReader();p.onload = function () {
    ...
    }, { "./is-buffer": 41, isarray: 28 }], 40: [function (t, e, n) {
      function r() {}function o(t) {
        var e = "",
            r = !1;return e += t.type, (n.BINARY_EVENT == t.type || n.BINARY_ACK == t.type) && (e += t.attachments, e += "-"), t.nsp && "/" != t.nsp && (r = !0, e += t.nsp), null != t.id && (r && (e += ",", r = !1), e += t.id), null != t.data && (r && (e += ","), e += f.stringify(t.data)), p("encoded %j as %s", t, e), e;
      }function i(t, e) {
        function n(t) {
        ...
        var e = {},
            r = 0;if (e.type = Number(t.charAt(0)), null == n.types[e.type]) return u();if (n.BINARY_EVENT == e.type || n.BINARY_ACK == e.type) {
    ...
    }, { "./binary": 39, "./is-buffer": 41, "component-emitter": 8, debug: 10, isarray: 28, json3: 42 }], 41: [function (t, e, n) {
      (function (t) {
        function n(e) {
          ...
          function o(t, e) {
            function n(t) {
              ...
              var k = "[object Function]",
                  ...
                  B = "[object Array]",
                  S = "[object Boolean]",
                  C = n("bug-string-char-index");if (!v) var E = h.floor,
                ...
                var j = { 92: "\\\\", 34: '\\"', 8: "\\b", 12: "\\f", 10: "\\n", 13: "\\r", 9: "\\t" },
                  ...
                  return (P + (e || 0)).slice(-t);
                    ...
                    R = "\\u00",
                    D = function D(t) {
                  for (var e = '"', n = 0, r = t.length, o = !C || r > 10, i = o && (C ? t.split("") : t); r > n; n++) {
                  ...
                  var a, c, u, p, h, l, m, v, w, k, C, O, j, P, R, q;try {
                    a = e[t];
                  } catch (L) {}if ("object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) && a) if (c = b.call(a), c != x || _d.call(a, "toJSON")) "function" == typeof a.toJSON && (c != _ && c != A && c != B || _d.call(a, "toJSON")) && (a = a.toJSON(t));else if (a > -1 / 0 && 1 / 0 > a) {
                    if (T) {
                      for (h = E(a / 864e5), u = E(h / 365.2425) + 1970 - 1; T(u + 1, 0) <= h; u++) {}for (p = E((h - T(u, 0)) / 30.42); T(u, p + 1) <= h; p++) {}h = 1 + h - T(u, p), l = (a % 864e5 + 864e5) % 864e5, m = E(l / 36e5) % 24, v = E(l / 6e4) % 60, w = E(l / 1e3) % 60, k = l % 1e3;
                    } else u = a.getUTCFullYear(), p = a.getUTCMonth(), h = a.getUTCDate(), m = a.getUTCHours(), v = a.getUTCMinutes(), w = a.getUTCSeconds(), k = a.getUTCMilliseconds();a = (0 >= u || u >= 1e4 ? (0 > u ? "-" : "+") + N(6, 0 > u ? -u : u) : N(4, u)) + "-" + N(2, p + 1) + "-" + N(2, h) + "T" + N(2, m) + ":" + N(2, v) + ":" + N(2, w) + "." + N(3, k) + "Z";
                  } else a = null;if (n && (a = n.call(e, t, a)), null === a) return "null";if (c = b.call(a), c == S) return "" + a;if (c == _) return a > -1 / 0 && 1 / 0 > a ? "" + a : "null";if (c == A) return D("" + a);if ("object" == (typeof a === "undefined" ? "undefined" : _typeof(a))) {
                    for (P = s.length; P--;) {
                      if (s[P] === a) throw f();
                    }if (s.push(a), C = [], R = i, i += o, c == B) {
                      for (j = 0, P = a.length; P > j; j++) {
                        O = U(j, a, n, r, o, i, s), C.push(O === g ? "null" : O);
                      }q = C.length ? o ? "[\n" + i + C.join(",\n" + i) + "\n" + R + "]" : "[" + C.join(",") + "]" : "[]";
                    } else _y(r || a, function (t) {
                      var e = U(t, a, n, r, o, i, s);e !== g && C.push(D(t) + ":" + (o ? " " : "") + e);
                    }), q = C.length ? o ? "{\n" + i + C.join(",\n" + i) + "\n" + R + "}" : "{" + C.join(",") + "}" : "{}";return s.pop(), q;
                  }
                };e.stringify = function (t, e, n) {
                  var r, o, i, a;if (s[typeof e === "undefined" ? "undefined" : _typeof(e)] && e) if ((a = b.call(e)) == k) o = e;else if (a == B) {
                    i = {};for (var c, u = 0, p = e.length; p > u; c = e[u++], a = b.call(c), (a == A || a == _) && (i[c] = 1)) {}
                  }if (n) if ((a = b.call(n)) == _) {
                    if ((n -= n % 1) > 0) for (r = "", n > 10 && (n = 10); r.length < n; r += " ") {}
                  } else a == A && (r = n.length <= 10 ? n : n.slice(0, 10));return U("", (c = {}, c[""] = t, c), o, i, r, "", []);
                };
              }if (!n("json-parse")) {
                var q,
                    L,
                  ...
                  for (var t, e, n, r, o, i = L, s = i.length; s > q;) {
                    switch (o = i.charCodeAt(q)) {
                      case 9:case 10:case 13:case 32:
                        ...
                        return t = C ? i.charAt(q) : i[q], q++, t;case 34:
                        for (t = "@", q++; s > q;) {
                  ...
                  var e, n;if ("$" == t && H(), "string" == typeof t) {
                    if ("@" == (C ? t.charAt(0) : t[0])) return t.slice(1);if ("[" == t) {
                      for (e = []; t = J(), "]" != t; n || (n = !0)) {
                        n && ("," == t ? (t = J(), "]" == t && H()) : H()), "," == t && H(), e.push(z(t));
                      }return e;
                    }if ("{" == t) {
                      for (e = {}; t = J(), "}" != t; n || (n = !0)) {
                        n && ("," == t ? (t = J(), "}" == t && H()) : H()), ("," == t || "string" != typeof t || "@" != (C ? t.charAt(0) : t[0]) || ":" != J()) && H(), e[t.slice(1)] = z(J());
                      }return e;
                    }H();
                  }return t;
                },
                  ...
                  var r = F(t, e, n);r === g ? delete t[e] : t[e] = r;
                    ...
                    F = function F(t, e, n) {
                  var r,
                      o = t[e];if ("object" == (typeof o === "undefined" ? "undefined" : _typeof(o)) && o) if (b.call(o) == B) for (r = o.length; r--;) {
                    X(o, r, n);
              ...
              u = a && s[typeof n === "undefined" ? "undefined" : _typeof(n)] && n && !n.nodeType && "object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) && e;if (!u || u.global !== u && u.window !== u && u.self !== u || (c = u), a && !i) o(c, a);else {
            var p = c.JSON,
                f = c.JSON3,
                h = !1,
                l = o(c, c.JSON3 = { noConflict: function noConflict() {
                return h || (h = !0, c.JSON = p, c.JSON3 = f, p = f = null), l;
        ...
        !function (o) {
          function i(t) {
            ...
            m = i(t), b = m.length, v = 0;for (var e, n = []; (e = h()) !== !1;) {
              ...
              k = { version: "2.0.0", encode: p, decode: l };if ("function" == typeof t && "object" == _typeof(t.amd) && t.amd) t(function () {
            return k;
          });else if (d && !d.nodeType) {
            if (y) y.exports = k;else {
              var x = {},
                  _ = x.hasOwnProperty;for (var A in k) {
                _.call(k, A) && (d[A] = k[A]);
              }
            }
          } else o.utf8 = k;
      ...
      function r(t) {
        ...
        var t = r(+new Date());return t !== s ? (p = 0, s = t) : t + "." + r(p++);
      }for (var s, a = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(""), c = 64, u = {}, p = 0, f = 0; c > f; f++) {
        u[a[f]] = f;
      ...
      function r(t, e) {
        ...
        function t(t, e) {
          ...
          a = function () {
        function t(e, n, o) {
          r(this, t);var i = this;this._id = 0, o.url = o.url.replace(/.*?:\/\//g, ""), this._runtimeProtoStubURL = e, this._bus = n, this._config = o, this._bus.addListener("*", function (t) {
            i._open(function () {
              i._filter(t) && i._sock.emit("message", JSON.stringify(t));
            });
          });
            ...
            var e = this;e._id++;var n = { id: e._id, type: "open", from: e._config.runtimeURL, to: "mn:/session" },
                r = !1;e._sessionCallback = function (o) {
              "response" === o.type & o.id === n.id && (r = !0, 200 === o.body.code ? (e._sendStatus("connected"), t()) : e._sendStatus("disconnected", o.body.desc));
            ...
            var t = this;t._id++;var e = { id: t._id, type: "close", from: t._config.runtimeURL, to: "mn:/session" };t._sock.send(JSON.stringify(e));
          } }, { key: "_sendStatus", value: function value(t, e) {
            var n = this,
                r = { type: "update", from: n._runtimeProtoStubURL, to: n._runtimeProtoStubURL + "/status", body: { value: t } };e && (r.body.desc = e), n._bus.postMessage(r);
          } }, { key: "_waitReady", value: function value(t) {
            var e = this;1 === e._sock.readyState ? t() : setTimeout(function () {
              e._waitReady(t);
            });
          } }, { key: "_filter", value: function value(t) {
            return t.body && t.body.via === this._runtimeProtoStubURL ? !1 : !0;
          } }, { key: "_deliver", value: function value(t) {
            t.body || (t.body = {}), t.body.via = this._runtimeProtoStubURL, this._bus.postMessage(t);
            ...
            var e = this;e._sock ? e._waitReady(t) : (e._sock = s(e._config.url, { forceNew: !0 }), e._sock.on("connect", function () {
              ...
              if ("object" != (typeof t === "undefined" ? "undefined" : _typeof(t))) try {
                t = JSON.parse(t);
              } catch (n) {
                t = {};
              }t.hasOwnProperty("from") && "mn:/session" === t.from ? e._sessionCallback && e._sessionCallback(t) : e._deliver(t);
            }), e._sock.on("disconnect", function (t) {
              e._sendStatus("disconnected", t), delete e._sock;
            }), e._sock.on("error", function (t) {}));
