...
(function ($) {
  ...
  $.fn.toc = function (options) {
    ...
    var calcHadingOffsets = function calcHadingOffsets() {
    ...
    //highlight on scroll
    var timeout;
    var highlightOnScroll = function highlightOnScroll(e) {
      if (!tocs.length) {
        return;
      }
      if (timeout) {
    ...
    return this.each(function () {
      ...
      headings.each(function (i, heading) {
        ...
        //build TOC item
        var a = $('<a class="list-group-item"/>').append(span).attr('href', '#' + opts.anchorName(i, heading, opts.prefix)).bind('click', function (e) {
          scrollTo(e);
  ...
  jQuery.fn.toc.defaults = {
    ...
    navbarOffset: 0,
    anchorName: function anchorName(i, heading, prefix) {
      return prefix + i;
    },
    headerText: function headerText(i, heading, $heading) {
      return $heading.text();
    },
    itemClass: function itemClass(i, heading, $heading, prefix) {
