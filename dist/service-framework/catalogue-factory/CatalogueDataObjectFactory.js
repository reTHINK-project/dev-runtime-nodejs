...
var CatalogueDataObjectFactory = function (_RethinkObject) {
    ...
    function CatalogueDataObjectFactory(validation, schema) {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(CatalogueDataObjectFactory).call(this, validation, schema));
    }
    ...
    _createClass(CatalogueDataObjectFactory, [{
        ...
        value: function createProtoStubDescriptorObject(guid, version, objectName, description, language, sourcePackageURL, messageSchemas, configuration, constraints) {
            ...
            return new _ProtocolStubDescriptor2.default(guid, _CatalogueDataObject.CatalogueObjectType.PROTOSTUB, version, objectName, description, language, sourcePackageURL, messageSchemas, configuration, constraints);
        }
        ...
        value: function createHypertyRuntimeDescriptorObject(guid, version, objectName, description, language, sourcePackageURL, runtimeType, hypertyCapabilities, protocolCapabilities) {
            ...
            return new _HypertyRuntimeDescriptor2.default(guid, _CatalogueDataObject.CatalogueObjectType.HYPERTY_RUNTIME, version, objectName, description, language, sourcePackageURL, runtimeType, hypertyCapabilities, protocolCapabilities);
        }
