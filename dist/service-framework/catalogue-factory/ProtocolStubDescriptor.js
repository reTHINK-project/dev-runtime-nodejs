...
var ProtocolStubDescriptor = function (_CatalogueDataObject) {
    ...
    function ProtocolStubDescriptor(guid, type, version, objectName, description, language, sourcePackageURL, messageSchemas, configuration, constraints) {
        _classCallCheck(this, ProtocolStubDescriptor);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ProtocolStubDescriptor).call(this, guid, type, version, objectName, description, language, sourcePackageURL));
