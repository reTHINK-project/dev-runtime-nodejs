...
var HypertyRuntimeDescriptor = function (_CatalogueDataObject) {
    ...
    function HypertyRuntimeDescriptor(guid, catalogueType, version, objectName, description, language, sourcePackageURL, runtimeType, hypertyCapabilities, protocolCapabilities) {
        _classCallCheck(this, HypertyRuntimeDescriptor);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(HypertyRuntimeDescriptor).call(this, guid, catalogueType, version, objectName, description, language, sourcePackageURL));
...
var RuntimeHypertyCapability = exports.RuntimeHypertyCapability = function () {
    ...
    _createClass(RuntimeHypertyCapability, [{
...
var RuntimeProtocolCapability = exports.RuntimeProtocolCapability = function () {
    ...
    _createClass(RuntimeProtocolCapability, [{
        key: 'isHttp',
